r"""The setup script for the ``emconstants`` library.
"""
...
# For setting up emconstants package.
...
def get_git_revision():
    """Get revision hash of ``emconstants`` from git.
    ...
    -------
    revision : `str`
        Git revision hash of ``emconstants``.
    """
...
def get_version_info():
    """Get version of ``emconstants`` from git.
...
def write__version_py(full_version,
    ...
    content = ("#!/usr/bin/env python\n"
               ...
               + "information about the\n# version of emconstants currently "
...
def clean():
    if sys.platform.startswith("win"):
        ...
        os.system("rmdir /s /q ./emconstants.egg-info")
        os.system("del /q ./*.pyc")
        os.system("del /q ./*.tgz")
        os.system("del /q ./emconstants/_version.py")
    else:
        os.system("rm -vrf ./build ./dist ./*.pyc "
                  "./*.tgz ./*.egg-info ./emconstants/_version.py")
...
def setup_package():
    ...
    description = \
        ("Stores values of physical constants that are used in electron "
         "microscopy.")

    setup(name="emconstants",
