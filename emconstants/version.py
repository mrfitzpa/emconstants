...
def _get_version_summary():
    """Get version summary of ``emconstants``.
    ...
    -------
    summary : `str`
        Version summary of ``emconstants``.
    """
    # Check versions of emconstants.
    from . import _version
    if _version.version != version:
        raise ValueError("emconstants version has changed since "
                         "installation/compilation")



    # Generate summary.
    summary = ("emconstants {emconstants_ver!s};\n"
               "git revision {git_rev!s} using\n"
               "python {python_ver!s}")
    
    summary = summary.format(emconstants_ver=full_version,
